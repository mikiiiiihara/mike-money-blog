  ...
  return (
    <div className={styles.post}>
      ...
      <div className={styles.content}>
        <p>
          本文書は、当サイト（Mike Money Life
          Blog）における個人情報の保護およびその適切な取り扱いについての方針を示したものです。
        </p>
        <h3>個人情報の利用目的</h3>
        <p>
          当ブログ(Mike Money Life
          Blog)では、お問い合わせや記事へのコメントの際、名前やメールアドレス等の個人情報を入力いただく場合がございます。
          取得した個人情報は、お問い合わせに対する回答や必要な情報を電子メールなどをでご連絡する場合に利用させていただくものであり、これらの目的以外では利用いたしません。
        </p>
        <h3>当サイトに掲載されている広告に関して</h3>
        <p>
          当サイトでは、第三者配信の広告サービス（A8.net、Access
          Trade、楽天リーベイツ）を利用しています。このような広告配信事業者は、ユーザーの興味に応じた商品やサービスの広告を表示するため、当サイトや他サイトへのアクセスに関する情報
